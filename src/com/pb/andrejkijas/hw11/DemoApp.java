package com.pb.andrejkijas.hw11;

import com.pb.andrejkijas.hw11.exception.NoFindRecordException;
import com.pb.andrejkijas.hw11.model.Phone;
import com.pb.andrejkijas.hw11.model.Phonebook;
import com.pb.andrejkijas.hw11.model.Record;
...
public class DemoApp {
    public static void main(String[] args) throws NoFindRecordException {
        ...
        System.out.println("-- Запись по фамилии");
        Record recByLastName = Phonebook.getRecordByLastName("Сидоров");
        System.out.println(recByLastName);

        System.out.println("-- Запись по номеру телефона");
        Record recByPhone = Phonebook.getRecordByPhone("+38 063 985-05-05");
